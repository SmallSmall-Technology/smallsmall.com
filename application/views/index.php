        ...
        <div class="col-9 mx-auto">
            <div class="text-center">
                ...
                <p class="description wow pixFadeUp" data-wow-delay="0.5s">
                    Whatever stage of your journey, whatever your living needs,<br />we are here to grow with you
                </p>
    ...
    <div class="row journey">
        <div class="col-9 mx-auto">
            <div class="text-center">
                ...
                <div class="readmore">
                    <a href="https://smallsmall.com/about" class="pxs-btn button-3d wow pixFadeUp googleplay" data-wow-delay="0.6s">
                        Read more
                    </a>
...
<section>
    <div class="section-inner">
        <div class="section-head-large rss"><span>Rent</span> Small Small</div>
        <div class="section-head-small">Subscribe and pay monthly</div>
                    ...
                    <div class="property-item">
                        <a target="_blank" href="https://rent.smallsmall.com/property/<?php echo $rss_value['propertyID']; ?>">
                            <div class="prop-img">
                                ...
                                <?php //}else{ ?>
                                    <!---<div class="availability-bar">Available - <span class="unavailable">Rented</span></div>--->
                                <?php //} ?>
                            </div>
                        </a>
                        ...
                        <div class="property-details-block">
                            <div class="detail-container">
                                <div class="detail-item"><span class="price"><span style="font-family:helvetica;font-weight:bold">&#x20A6;</span><b><?php echo number_format($rss_value['price'] + $rss_value['serviceCharge']); ?></b> / month</span></div>
                                <div class="detail-item"><?php echo $rss_value['bed']; ?> Bed | <?php echo $rss_value['bath']; ?> Bath</div>
                            </div>
                            <div class="detail-container">
...
<section>
    <div class="section-inner">
        <div class="section-head-large sss"><span>Stay</span> Small Small</div>
        <div class="section-head-small">Subscribe and pay nightly</div>
        <div class="property-container">
                ...
                <?php foreach($sss_properties as $sss_property => $sss_value){ ?>
                    <div class="property-item">
                        ...
                        <div class="property-details-block">
                            <div class="detail-container">
                                <div class="detail-item">
                                    <span class="price"><span style="font-family:helvetica;font-weight:bold">&#x20A6;</span><b><?php echo number_format($sss_value['price']); ?></b> / night
                                    </span>
                                </div>
                                <div class="detail-item"><?php echo $sss_value['bedroom']; ?> Bed | <?php echo $sss_value['bathroom']; ?> Bath</div>
                            </div>
                            <div class="detail-container">
                                <div class="detail-item">
                                    <a target="_blank" href="https://stay.smallsmall.com/apartment/<?php echo $sss_value['apartmentID']; ?>">
...
<section>
    <div class="section-inner">
        <div class="section-head-large bss"><span>Buy</span> Small Small</div>
        <div class="section-head-small">Own a property today</div>
        <div class="property-container">
                        ...
                        <div class="property-details-block">
                            <div class="detail-container">
                                <div class="price-description">
                                    <?php if(@$bss_value['pool_buy'] == 'yes'){ ?>
                                        <span style="display:block;width:100%;font-size:10px;font-weight:bold;color:#333">Starting Price</span>
                                        
                                    <?php }else{ ?>
                                        <span style="display:block;width:100%;font-size:10px;font-weight:bold;color:#333">Minimum Down Payment</span>
                                        
                                    <?php } ?>
                                </div>
                                <div class="detail-item">
                                    <?php if(@$bss_value['pool_buy'] == 'yes'){ ?>
                                        <span class="price"><span style="font-family:helvetica;font-weight:bold">&#x20A6;</span><b><?php echo number_format($bss_value['price']); ?></b>
                                        </span>
                                    <?php }else{ ?>
                                        <span class="price"><span style="font-family:helvetica;font-weight:bold">&#x20A6;</span><b><?php echo number_format($bss_value['price'] * ($bss_value['minimum_payment_plan']/100)); ?></b>
                                        </span>
                                    <?php } ?>
                                </div>
                                <div class="detail-item"><?php echo $bss_value['bed']; ?> Bed | <?php echo $bss_value['bath']; ?> Bath</div>
                            </div>
                            <div class="detail-container">
                                <div class="detail-item">
