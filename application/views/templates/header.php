...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/style.css?version=<?php echo rand(199, 99999999); ?>" type="text/css" media="all">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/select-menu.css?version=<?php echo rand(199, 99999999); ?>" type="text/css" media="all">
...
<body>
	<header>
		<div class="header-inner">
			...
			<div class="header-logo"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/smallsmall-logo.svg" alt="smallsmall logo" /></a></div>
				...
				<ul class="menu">
					<li id="menu-item-products" class="menu-item menu-item-parent"><a>Products <i class="fa fa-chevron-down"></i></a>
						<ul id="products-menu" class="sub-menu">
							...
							<li class="menu-item">
								<a href="https://buy.smallsmall.com">BuySmallSmall</a>
								<span class="menu-description">
